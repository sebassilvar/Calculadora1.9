...
String signo;
 ...
 resultado=Double.parseDouble(dato1)/Double.parseDouble(dato2);
    ...
    if(signo.equals("Km")){
     resultado=Double.parseDouble(dato1)*0.000621504;
    }
    if(signo.equals("Cos")){
     a=Double.parseDouble(dato1);
    ...
    if(signo.equals("Mill")){
     resultado=Double.parseDouble(dato1)*1609;
    }
    if(signo.equals("ºC")){
     resultado=(Double.parseDouble(dato1)-32)/1.800;
    }
     if(signo.equals("ºF")){
     resultado=(Double.parseDouble(dato1)*1.8)+32;
    }
     if(signo.equals("Gr")){
     resultado=Double.parseDouble(dato1)*1000;
    }
     if(signo.equals("Kg")){
     resultado=Double.parseDouble(dato1)/1000;
    }
